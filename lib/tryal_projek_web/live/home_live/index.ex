defmodule TryalProjekWeb.HomeLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :homes, Homepage.list_homes())}
  end
  ...
  @impl true
  def handle_info({TryalProjekWeb.HomeLive.FormComponent, {:saved, home}}, socket) do
    {:noreply, stream_insert(socket, :homes, home)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    home = Homepage.get_home!(id)
    {:ok, _} = Homepage.delete_home(home)
